	...
	for (var i=0; i<arts.length; i++) {
		artsPart = artsPart + 	"<div class='container-fluid'>" +
									"<div class='row-fluid'>" +
										...
										"<div class='col-md-8><a href='javascript:void(0)'>" +
											arts[i].title +
										"</a></div>" +
									"</div>" +
									"<div class='row-fluid'><hr class='col-md-8 col-md-offset-2' /></div>" +
								  	"<div class='row-fluid'>" +
								  		"<div class='col-md-8 col-md-offset-2 artText-" + arts[i].articleId +"'>" +
								  			arts[i].text +
								  		"</div>" +
								  	"</div></br>" +
								  	"<div class='row-fluid'><div class='col-md-2 col-md-offset-10'>" +
								  		"<p onclick='collapse(" + arts[i].articleId + ")' class='collapse-" + arts[i].articleId + "'>收起</p>" +
								  	"</div></div>" +
